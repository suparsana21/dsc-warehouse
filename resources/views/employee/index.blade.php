                ...
                <table class="c-table">
                        <thead class="c-table__head">
                            <tr class="c-table__row">
                                ...
                                <th class="c-table__cell c-table__cell--head">Nomor pegawai</th>
                        ...
                        <tbody>
                            @foreach($datas as $data)
                                <tr class="c-table__row">
                                    ...
                                    <td class="c-table__cell">{{$data->no_pegawai}}</td>
                                    <td class="c-table__cell">{{$data->name}}</td>
                                    <td class="c-table__cell">{{$data->alamat}}</td>
                                    <td class="c-table__cell">{{$data->jenis_kelamin}}</td>
                                    <td class="c-table__cell">
                                        <a href="{{route("employee.edit",['id' => $data->id])}}" class="c-btn c-btn--warning c-btn--small">Edit</a> 
